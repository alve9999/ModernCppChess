...
fastchess -engine cmd="$1" name="$exec1_name" -engine cmd="$2" name="$exec2_name" \
    -openings file=Pohl.epd plies=4 format=epd order=random -each tc=5+0.05 -sprt elo0=0 elo1=10 alpha=0.10 beta=0.10 model=normalized -rounds 15000 -repeat -recover -concurrency $3 -log file=fastchess_log engine=true
